# Job Card — CRO — Chief Revenue Officer

> slug: `cro-revenue` · dept: `c_level` · damga: 2026-08-27T20:16:49Z
...
## Mission
Deliver measurable outcomes for CRO — Chief Revenue Officer within the AdOps agency org (600 agents).
Align daily work to OKR cascade from `ROADMAP/cro-revenue.md`.
...
3. Contribute forecasts to `FORECASTS/cro-revenue/` (workflow: 200/day target, not one-shot).
4. Escalate blockers >4h to sponsor per `data/org.json`.

## RACI (draft)
| Activity | R | A | C | I |
|---|---|---|---|---|
| Daily ops | cro-revenue | dept-head | QA | owner |
