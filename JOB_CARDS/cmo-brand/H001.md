# H001 — Heading 1 (cmo-brand)

> status: scaffold · min 200+200+200 chars per heading when expanded

## Description (expand to 200+ chars)
Role-specific guidance block 1 for `cmo-brand`. Cover mission alignment, stakeholder
context, and measurable outcome. Cite `RESEARCH/cmo-brand.md` when available.
...
queue in `EXPERTS/cmo-brand/`. Human review required for unverified claims.
