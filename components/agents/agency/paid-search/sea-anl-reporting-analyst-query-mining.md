---
name: sea-anl-reporting-analyst-query-mining
...
## 5. KPI & OKR
- Impression share on brand ≥ 90% · ölçüm: haftalık kesit · sahip: `sea-anl-reporting-analyst-query-mining`
- Wasted spend < 5% · ölçüm: haftalık kesit · sahip: `sea-anl-reporting-analyst-query-mining`
- tCPA/tROAS attainment · ölçüm: haftalık kesit · sahip: `sea-anl-reporting-analyst-query-mining`
- QS trend up · ölçüm: haftalık kesit · sahip: `sea-anl-reporting-analyst-query-mining`
