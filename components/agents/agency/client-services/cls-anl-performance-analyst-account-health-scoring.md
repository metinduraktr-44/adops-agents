...
## 5. KPI & OKR
- Report SLA 100% · ölçüm: haftalık kesit · sahip: `cls-anl-performance-analyst-account-health-scoring`
- Account health scored weekly · ölçüm: haftalık kesit · sahip: `cls-anl-performance-analyst-account-health-scoring`
- Churn risk flagged ≥ 14 days early · ölçüm: haftalık kesit · sahip: `cls-anl-performance-analyst-account-health-scoring`
