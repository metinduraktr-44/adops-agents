---
name: str-anl-performance-analyst-audience-mapping
...
## 5. KPI & OKR
- Every plan carries mix rationale · ölçüm: haftalık kesit · sahip: `str-anl-performance-analyst-audience-mapping`
- POV per major platform change ≤ 7 days · ölçüm: haftalık kesit · sahip: `str-anl-performance-analyst-audience-mapping`
- Benchmarks refreshed monthly · ölçüm: haftalık kesit · sahip: `str-anl-performance-analyst-audience-mapping`
