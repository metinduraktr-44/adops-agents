---
name: dsc-anl-performance-analyst-agent-eval-harness
...
## 5. KPI & OKR
- Forecast MAPE ≤ 15% · ölçüm: haftalık kesit · sahip: `dsc-anl-performance-analyst-agent-eval-harness`
- 1 model improvement/month · ölçüm: haftalık kesit · sahip: `dsc-anl-performance-analyst-agent-eval-harness`
- Agent eval pass rate ≥ 95% · ölçüm: haftalık kesit · sahip: `dsc-anl-performance-analyst-agent-eval-harness`
