---
name: dsc-anl-performance-analyst-ltv-prediction
...
## 5. KPI & OKR
- Forecast MAPE ≤ 15% · ölçüm: haftalık kesit · sahip: `dsc-anl-performance-analyst-ltv-prediction`
- 1 model improvement/month · ölçüm: haftalık kesit · sahip: `dsc-anl-performance-analyst-ltv-prediction`
- Agent eval pass rate ≥ 95% · ölçüm: haftalık kesit · sahip: `dsc-anl-performance-analyst-ltv-prediction`
