---
name: mob-anl-reporting-analyst-fraud-detection
...
## 5. KPI & OKR
- SKAN CV coverage ≥ 85% · ölçüm: haftalık kesit · sahip: `mob-anl-reporting-analyst-fraud-detection`
- Fraud rate < 3% · ölçüm: haftalık kesit · sahip: `mob-anl-reporting-analyst-fraud-detection`
- D7 ROAS vs plan · ölçüm: haftalık kesit · sahip: `mob-anl-reporting-analyst-fraud-detection`
- Organic uplift measured · ölçüm: haftalık kesit · sahip: `mob-anl-reporting-analyst-fraud-detection`
