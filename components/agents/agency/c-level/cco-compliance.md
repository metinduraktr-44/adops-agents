...
- [ ] 'Enforce the 5 security rules on every component' — bugün bunu ilerlettim mi; kanıt/metrik ne?
- [ ] 'License hygiene on any ingested source' — bugün bunu ilerlettim mi; kanıt/metrik ne?
- [ ] 'Ad-policy sanity checks in playbooks' — bugün bunu ilerlettim mi; kanıt/metrik ne?
- [ ] 'Own AUDIT_LOG.jsonl integrity' — bugün bunu ilerlettim mi; kanıt/metrik ne?
...
## 5. KPI & OKR
- **0 license violations** · ölçüm: haftalık kesit · sahip: `cco-compliance`
  - [ ] Hedefte mi? Sapma varsa kök neden + düzeltme ne?
  - [ ] Tanımı ve kaynağı yazılı mı; tahmin içeriyorsa etiketli mi?
  - [ ] Bu KPI'ı bir öncekiyle kıyasladım mı (trend yönü)?
- **100% components pass security screen** · ölçüm: haftalık kesit · sahip: `cco-compliance`
  - [ ] Hedefte mi? Sapma varsa kök neden + düzeltme ne?
  - [ ] Tanımı ve kaynağı yazılı mı; tahmin içeriyorsa etiketli mi?
  - [ ] Bu KPI'ı bir öncekiyle kıyasladım mı (trend yönü)?
- **Audit chain unbroken** · ölçüm: haftalık kesit · sahip: `cco-compliance`
  - [ ] Hedefte mi? Sapma varsa kök neden + düzeltme ne?
  - [ ] Tanımı ve kaynağı yazılı mı; tahmin içeriyorsa etiketli mi?
  - [ ] Bu KPI'ı bir öncekiyle kıyasladım mı (trend yönü)?
