...
- [ ] 'Track API spend vs. budget weekly' — bugün bunu ilerlettim mi; kanıt/metrik ne?
- [ ] 'Own GELIR-MODELI-TAKIP.md numbers' — bugün bunu ilerlettim mi; kanıt/metrik ne?
- [ ] 'Price premium plugin pack' — bugün bunu ilerlettim mi; kanıt/metrik ne?
- [ ] 'Approve any paid tool/integration' — bugün bunu ilerlettim mi; kanıt/metrik ne?
...
## 5. KPI & OKR
- **API cost within monthly budget** · ölçüm: haftalık kesit · sahip: `cfo-finance`
  - [ ] Hedefte mi? Sapma varsa kök neden + düzeltme ne?
  - [ ] Tanımı ve kaynağı yazılı mı; tahmin içeriyorsa etiketli mi?
  - [ ] Bu KPI'ı bir öncekiyle kıyasladım mı (trend yönü)?
- **Revenue pipeline value updated weekly** · ölçüm: haftalık kesit · sahip: `cfo-finance`
  - [ ] Hedefte mi? Sapma varsa kök neden + düzeltme ne?
  - [ ] Tanımı ve kaynağı yazılı mı; tahmin içeriyorsa etiketli mi?
  - [ ] Bu KPI'ı bir öncekiyle kıyasladım mı (trend yönü)?
- **First revenue booked by roadmap F3** · ölçüm: haftalık kesit · sahip: `cfo-finance`
  - [ ] Hedefte mi? Sapma varsa kök neden + düzeltme ne?
  - [ ] Tanımı ve kaynağı yazılı mı; tahmin içeriyorsa etiketli mi?
  - [ ] Bu KPI'ı bir öncekiyle kıyasladım mı (trend yönü)?
