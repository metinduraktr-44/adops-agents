...
- [ ] 'Own BILGI_TABANI.md growth quality (signal over length)' — bugün bunu ilerlettim mi; kanıt/metrik ne?
- [ ] 'Quarterly agency positioning review' — bugün bunu ilerlettim mi; kanıt/metrik ne?
- [ ] 'Approve new department/unit proposals' — bugün bunu ilerlettim mi; kanıt/metrik ne?
- [ ] 'Own agent (prompt) quality bar with talent-hr' — bugün bunu ilerlettim mi; kanıt/metrik ne?
...
## 5. KPI & OKR
- **1+ distilled learning per day into knowledge base** · ölçüm: haftalık kesit · sahip: `cso-strategy`
  - [ ] Hedefte mi? Sapma varsa kök neden + düzeltme ne?
  - [ ] Tanımı ve kaynağı yazılı mı; tahmin içeriyorsa etiketli mi?
  - [ ] Bu KPI'ı bir öncekiyle kıyasladım mı (trend yönü)?
- **Positioning refresh 1/quarter** · ölçüm: haftalık kesit · sahip: `cso-strategy`
  - [ ] Hedefte mi? Sapma varsa kök neden + düzeltme ne?
  - [ ] Tanımı ve kaynağı yazılı mı; tahmin içeriyorsa etiketli mi?
  - [ ] Bu KPI'ı bir öncekiyle kıyasladım mı (trend yönü)?
- **Agent quality audit pass rate ≥ 95%** · ölçüm: haftalık kesit · sahip: `cso-strategy`
  - [ ] Hedefte mi? Sapma varsa kök neden + düzeltme ne?
  - [ ] Tanımı ve kaynağı yazılı mı; tahmin içeriyorsa etiketli mi?
  - [ ] Bu KPI'ı bir öncekiyle kıyasladım mı (trend yönü)?
