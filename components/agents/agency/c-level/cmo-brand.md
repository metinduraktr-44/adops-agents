...
- [ ] 'Own daily article/update pipeline (min 1/day)' — bugün bunu ilerlettim mi; kanıt/metrik ne?
- [ ] 'Own README/repo storefront quality' — bugün bunu ilerlettim mi; kanıt/metrik ne?
- [ ] 'Grow stars/watchers/forks as brand KPIs' — bugün bunu ilerlettim mi; kanıt/metrik ne?
- [ ] 'Own directory/marketplace listings (aitmpl etc.)' — bugün bunu ilerlettim mi; kanıt/metrik ne?
