---
name: soc-spc-optimization-meta-aso-structure
...
## 5. KPI & OKR
- **Thumbstop/hook rate on target** · ölçüm: haftalık kesit · sahip: `soc-spc-optimization-meta-aso-structure`
  - [ ] Hedefte mi? Sapma varsa kök neden + düzeltme ne?
  - [ ] Tanımı ve kaynağı yazılı mı; tahmin içeriyorsa etiketli mi?
  - [ ] Bu KPI'ı bir öncekiyle kıyasladım mı (trend yönü)?
- **CAPI EMQ ≥ 8** · ölçüm: haftalık kesit · sahip: `soc-spc-optimization-meta-aso-structure`
  - [ ] Hedefte mi? Sapma varsa kök neden + düzeltme ne?
  - [ ] Tanımı ve kaynağı yazılı mı; tahmin içeriyorsa etiketli mi?
  - [ ] Bu KPI'ı bir öncekiyle kıyasladım mı (trend yönü)?
- **Creative refresh cadence met** · ölçüm: haftalık kesit · sahip: `soc-spc-optimization-meta-aso-structure`
  - [ ] Hedefte mi? Sapma varsa kök neden + düzeltme ne?
  - [ ] Tanımı ve kaynağı yazılı mı; tahmin içeriyorsa etiketli mi?
  - [ ] Bu KPI'ı bir öncekiyle kıyasladım mı (trend yönü)?
- **Blended CPA vs plan** · ölçüm: haftalık kesit · sahip: `soc-spc-optimization-meta-aso-structure`
  - [ ] Hedefte mi? Sapma varsa kök neden + düzeltme ne?
  - [ ] Tanımı ve kaynağı yazılı mı; tahmin içeriyorsa etiketli mi?
  - [ ] Bu KPI'ı bir öncekiyle kıyasladım mı (trend yönü)?
