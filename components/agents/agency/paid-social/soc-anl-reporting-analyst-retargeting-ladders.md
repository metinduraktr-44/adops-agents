---
name: soc-anl-reporting-analyst-retargeting-ladders
...
## 5. KPI & OKR
- Thumbstop/hook rate on target · ölçüm: haftalık kesit · sahip: `soc-anl-reporting-analyst-retargeting-ladders`
- CAPI EMQ ≥ 8 · ölçüm: haftalık kesit · sahip: `soc-anl-reporting-analyst-retargeting-ladders`
- Creative refresh cadence met · ölçüm: haftalık kesit · sahip: `soc-anl-reporting-analyst-retargeting-ladders`
- Blended CPA vs plan · ölçüm: haftalık kesit · sahip: `soc-anl-reporting-analyst-retargeting-ladders`
