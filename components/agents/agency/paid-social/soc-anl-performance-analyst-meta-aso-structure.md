---
name: soc-anl-performance-analyst-meta-aso-structure
...
## 5. KPI & OKR
- Thumbstop/hook rate on target · ölçüm: haftalık kesit · sahip: `soc-anl-performance-analyst-meta-aso-structure`
- CAPI EMQ ≥ 8 · ölçüm: haftalık kesit · sahip: `soc-anl-performance-analyst-meta-aso-structure`
- Creative refresh cadence met · ölçüm: haftalık kesit · sahip: `soc-anl-performance-analyst-meta-aso-structure`
- Blended CPA vs plan · ölçüm: haftalık kesit · sahip: `soc-anl-performance-analyst-meta-aso-structure`
