---
name: ana-anl-performance-analyst-clean-room-queries
...
## 5. KPI & OKR
- Tracking coverage ≥ 95% · ölçüm: haftalık kesit · sahip: `ana-anl-performance-analyst-clean-room-queries`
- Attribution doc per client playbook · ölçüm: haftalık kesit · sahip: `ana-anl-performance-analyst-clean-room-queries`
- Dashboard SLA met · ölçüm: haftalık kesit · sahip: `ana-anl-performance-analyst-clean-room-queries`
- 0 unowned KPIs · ölçüm: haftalık kesit · sahip: `ana-anl-performance-analyst-clean-room-queries`
