---
name: holding-tech-dir-backend
description: "Director — Backend/API — PermerGrowth Tech (App iOS/Android) kişisel workflow paketi (holding)."
tier: DIRECTOR
subsidiary: "PermerGrowth Tech (App iOS/Android)"
generated_utc: 2026-08-04T08:44:04Z
---
# Director — Backend/API — PermerGrowth Tech (App iOS/Android)
...
## Kişisel Workflow'lar — Director — Backend/API
