...
## İştirakler
- **PermerGrowth Holding** (`permergrowth-holding`) — 6 C-level
- **PermerGrowth Performance** (`permergrowth-performance`) — 8 rol
- **PermerGrowth Hukuk** (`permergrowth-legal`) — 5 rol
- **VizaTrack** (`vizatrack`) — 6 rol
- **PermerGrowth Tech (App iOS/Android)** (`permergrowth-tech`) — 7 rol
