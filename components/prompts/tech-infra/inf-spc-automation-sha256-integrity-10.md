---
name: prompt-inf-spc-automation-sha256-integrity-10
description: "Automation Specialist, Sha256 Integrity — Tech & Infrastructure — title/ekip/uygulama prompt ailesi (Teknoloji & Altyapı)."
tier: SPECIALIST
department: "Tech & Infrastructure"
generated_utc: 2026-08-04T08:49:06Z
---
# PROMPT — Automation Specialist, Sha256 Integrity — Tech & Infrastructure
...
```prompt
Sen: Automation Specialist, Sha256 Integrity — Tech & Infrastructure (Teknoloji & Altyapı / SPECIALIST)
...
```prompt
Sen: Teknoloji & Altyapı ekibinin bir üyesi olarak Automation Specialist, Sha256 Integrity — Tech & Infrastructure (Teknoloji & Altyapı / SPECIALIST)
...
```prompt
Sen: Automation Specialist, Sha256 Integrity — Tech & Infrastructure (Teknoloji & Altyapı / SPECIALIST) için otomasyon mühendisi
