---
name: prompt-sea-lead-negative-keyword-hygiene
...
```prompt
Sen: Lead, Negative Keyword Hygiene — Paid Search (Ücretli Arama / LEAD)
...
```prompt
Sen: Ücretli Arama ekibinin bir üyesi olarak Lead, Negative Keyword Hygiene — Paid Search (Ücretli Arama / LEAD)
...
```prompt
Sen: Lead, Negative Keyword Hygiene — Paid Search (Ücretli Arama / LEAD) için otomasyon mühendisi
