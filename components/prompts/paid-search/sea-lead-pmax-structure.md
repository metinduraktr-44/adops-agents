---
name: prompt-sea-lead-pmax-structure
description: "Lead, Pmax Structure — Paid Search — title/ekip/uygulama prompt ailesi (Ücretli Arama)."
tier: LEAD
department: "Paid Search"
generated_utc: 2026-08-04T08:49:06Z
---
# PROMPT — Lead, Pmax Structure — Paid Search
> Departman: **Ücretli Arama** (sea) · Kademe: **LEAD** · Rapor: `sea-dir-sa360-and-automation` · Üretim: 2026-08-04T08:49:06Z
...
```prompt
Sen: Lead, Pmax Structure — Paid Search (Ücretli Arama / LEAD)
...
```prompt
Sen: Ücretli Arama ekibinin bir üyesi olarak Lead, Pmax Structure — Paid Search (Ücretli Arama / LEAD)
...
```prompt
Sen: Lead, Pmax Structure — Paid Search (Ücretli Arama / LEAD) için otomasyon mühendisi
