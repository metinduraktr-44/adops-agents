---
name: prompt-prg-spc-optimization-pmp-deal-desk-3
description: "Optimization Specialist, Pmp Deal Desk — Programmatic Trading — title/ekip/uygulama prompt ailesi (Programatik Satın Alma)."
tier: SPECIALIST
department: "Programmatic Trading"
generated_utc: 2026-08-04T08:44:03Z
---
# PROMPT — Optimization Specialist, Pmp Deal Desk — Programmatic Trading
...
```prompt
Sen: Optimization Specialist, Pmp Deal Desk — Programmatic Trading (Programatik Satın Alma / SPECIALIST)
...
```prompt
Sen: Programatik Satın Alma ekibinin bir üyesi olarak Optimization Specialist, Pmp Deal Desk — Programmatic Trading (Programatik Satın Alma / SPECIALIST)
...
```prompt
Sen: Optimization Specialist, Pmp Deal Desk — Programmatic Trading (Programatik Satın Alma / SPECIALIST) için otomasyon mühendisi
