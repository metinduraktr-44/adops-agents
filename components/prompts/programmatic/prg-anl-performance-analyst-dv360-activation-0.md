---
name: prompt-prg-anl-performance-analyst-dv360-activation-0
description: "Performance Analyst, Dv360 Activation — Programmatic Trading — title/ekip/uygulama prompt ailesi (Programatik Satın Alma)."
tier: ANALYST
department: "Programmatic Trading"
generated_utc: 2026-08-04T08:49:06Z
---
# PROMPT — Performance Analyst, Dv360 Activation — Programmatic Trading
> Departman: **Programatik Satın Alma** (prg) · Kademe: **ANALYST** · Rapor: `prg-lead-dv360-activation` · Üretim: 2026-08-04T08:49:06Z
...
```prompt
Sen: Performance Analyst, Dv360 Activation — Programmatic Trading (Programatik Satın Alma / ANALYST)
...
```prompt
Sen: Programatik Satın Alma ekibinin bir üyesi olarak Performance Analyst, Dv360 Activation — Programmatic Trading (Programatik Satın Alma / ANALYST)
...
```prompt
Sen: Performance Analyst, Dv360 Activation — Programmatic Trading (Programatik Satın Alma / ANALYST) için otomasyon mühendisi
