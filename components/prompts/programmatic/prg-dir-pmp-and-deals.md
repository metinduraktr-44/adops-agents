---
name: prompt-prg-dir-pmp-and-deals
description: "Director, PMP & Deals — Programmatic Trading — title/ekip/uygulama prompt ailesi (Programatik Satın Alma)."
tier: DIRECTOR
department: "Programmatic Trading"
generated_utc: 2026-08-04T08:49:06Z
---
# PROMPT — Director, PMP & Deals — Programmatic Trading
...
```prompt
Sen: Director, PMP & Deals — Programmatic Trading (Programatik Satın Alma / DIRECTOR)
...
```prompt
Sen: Programatik Satın Alma ekibinin bir üyesi olarak Director, PMP & Deals — Programmatic Trading (Programatik Satın Alma / DIRECTOR)
...
```prompt
Sen: Director, PMP & Deals — Programmatic Trading (Programatik Satın Alma / DIRECTOR) için otomasyon mühendisi
