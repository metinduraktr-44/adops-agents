---
name: prompt-cro-dir-landing-systems
...
```prompt
Sen: Director, Landing Systems — CRO & Experience (CRO & Deneyim / DIRECTOR)
...
```prompt
Sen: CRO & Deneyim ekibinin bir üyesi olarak Director, Landing Systems — CRO & Experience (CRO & Deneyim / DIRECTOR)
...
```prompt
Sen: Director, Landing Systems — CRO & Experience (CRO & Deneyim / DIRECTOR) için otomasyon mühendisi
