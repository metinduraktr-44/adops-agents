---
name: prompt-ret-spc-automation-criteo-retail-11
description: "Automation Specialist, Criteo Retail — Retail & Commerce Media — title/ekip/uygulama prompt ailesi (Perakende Medyası)."
tier: SPECIALIST
department: "Retail & Commerce Media"
generated_utc: 2026-08-04T08:49:06Z
---
# PROMPT — Automation Specialist, Criteo Retail — Retail & Commerce Media
...
```prompt
Sen: Automation Specialist, Criteo Retail — Retail & Commerce Media (Perakende Medyası / SPECIALIST)
...
```prompt
Sen: Perakende Medyası ekibinin bir üyesi olarak Automation Specialist, Criteo Retail — Retail & Commerce Media (Perakende Medyası / SPECIALIST)
...
```prompt
Sen: Automation Specialist, Criteo Retail — Retail & Commerce Media (Perakende Medyası / SPECIALIST) için otomasyon mühendisi
