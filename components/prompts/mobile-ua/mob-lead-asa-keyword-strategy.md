---
name: prompt-mob-lead-asa-keyword-strategy
...
```prompt
Sen: Lead, Asa Keyword Strategy — Mobile UA & App Growth (Mobil UA & Uygulama / LEAD)
...
```prompt
Sen: Mobil UA & Uygulama ekibinin bir üyesi olarak Lead, Asa Keyword Strategy — Mobile UA & App Growth (Mobil UA & Uygulama / LEAD)
...
```prompt
Sen: Lead, Asa Keyword Strategy — Mobile UA & App Growth (Mobil UA & Uygulama / LEAD) için otomasyon mühendisi
