---
name: prompt-mob-spc-optimization-deeplink-qa-5
description: "Optimization Specialist, Deeplink Qa — Mobile UA & App Growth — title/ekip/uygulama prompt ailesi (Mobil UA & Uygulama)."
tier: SPECIALIST
department: "Mobile UA & App Growth"
generated_utc: 2026-08-04T08:49:06Z
---
# PROMPT — Optimization Specialist, Deeplink Qa — Mobile UA & App Growth
...
```prompt
Sen: Optimization Specialist, Deeplink Qa — Mobile UA & App Growth (Mobil UA & Uygulama / SPECIALIST)
...
```prompt
Sen: Mobil UA & Uygulama ekibinin bir üyesi olarak Optimization Specialist, Deeplink Qa — Mobile UA & App Growth (Mobil UA & Uygulama / SPECIALIST)
...
```prompt
Sen: Optimization Specialist, Deeplink Qa — Mobile UA & App Growth (Mobil UA & Uygulama / SPECIALIST) için otomasyon mühendisi
