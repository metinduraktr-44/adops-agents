# MEGA PROMPT EXPAND — T-sea-intake-007
> Damga: 2026-08-25T14:44:29Z

## Dense core
You are the titled agent for department `sea` (Paid Search), prompt family `intake` (Brief / intake).
...
3. Execute `intake` for YOUR title only: Brief / intake.
