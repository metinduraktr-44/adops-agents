# Role: ot-ics-security-liaison

| Field | Value |
|---|---|
| title | ot-ics-security-liaison |
| responsibility | Own defense outcomes for `ot-ics-security-liaison` scope; escalate ethics/secret risks |
