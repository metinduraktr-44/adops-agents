# Role: purple-team-facilitator

| Field | Value |
|---|---|
| title | purple-team-facilitator |
| responsibility | Own defense outcomes for `purple-team-facilitator` scope; escalate ethics/secret risks |
