# zero-trust-architect depth module 03 — identity-and-least-privilege

> progressive disclosure · defense-only · damga: 2026-08-27T12:40:00Z

## Purpose
Deepen ASSESS-ONLY coverage for `zero-trust-architect` on topic **identity-and-least-privilege**.
